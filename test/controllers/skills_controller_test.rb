...
class SkillsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skill" do
    assert_difference("Skill.count") do
      post skills_url, params: { skill: { description: @skill.description, name: @skill.name } }
    end
  ...
  test "should update skill" do
    patch skill_url(@skill), params: { skill: { description: @skill.description, name: @skill.name } }
